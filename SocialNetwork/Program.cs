...
class Program
{
    ...
    private static void Main(string[] args)
    {
        ...
        Console.WriteLine("Добро пожаловать в Social Network!");
                ...
                case "2":  
                    {
                        ...
                        {
                            Console.WriteLine($"Произошла ошибка при регистрации. Код ошибки: {e.Message}");
                        }
    ...
    public static void GetInputInformation(ref string input, string text)
    {
        Console.Write($"Введите {text} пользователя: ");
